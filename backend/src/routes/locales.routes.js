...
const localesController = require('../controllers/locales.controller');
const authMiddleware = require('../middleware/auth.middleware');
const { crearLocalValidator } = require('../validators/locales.validator');
...
router.post('/', authMiddleware, crearLocalValidator, validate, localesController.create);
